...
import {OngoingDeliveryStatus} from './components/delivery-status';

const deviceHeight = Dimensions.get('window').height;
const deviceWidth = Dimensions.get('window').width;

export default function OngoingDeliveryScreen(props) {
    ...
    <View style={styles.mainContainer}>
      <ScrollView
              ...
              <View style={styles.cartItemsContainer}>
                <View style={styles.ordersContainer}>
                  <View style={styles.ordersInnerContainer}>
                    ...
                    />
                    <View>
                      <Text style={styles.ordersFromText}>Order from</Text>
        ...
        <View style={styles.progressMainContent}>
          <OngoingDeliveryStatus deliveryStatus={deliveryStatus} />
        </View>
      </ScrollView>
    </View>
  );
