...
import {CheckoutOrderRemovalModal} from './components/removal-modal';
const deviceHeight = Dimensions.get('window').height;
const deviceWidth = Dimensions.get('window').width;

export default function CheckoutDeliveryConfirmOrderScreen(props) {
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.buttonContainer}>
          <ActionButton
            ...
            onPress={() =>
              props.navigation.navigate('CheckoutDeliveryProceedScreen')
            }
          />
        </View>
      </View>
